...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab <-}\StringTok{ }\NormalTok{gapminder }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(year }\OperatorTok{>=}\StringTok{ }\DecValTok{1960} \OperatorTok{&}\StringTok{ }\NormalTok{year }\OperatorTok{<=}\StringTok{ }\DecValTok{2010} \OperatorTok{&}\StringTok{ }\NormalTok{country}\OperatorTok{%in%}\KeywordTok{c}\NormalTok{(}\StringTok{"Vietnam"}\NormalTok{, }\StringTok{"United States"}\NormalTok{))}
\NormalTok{tab}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{daydollars <-}\StringTok{ }\NormalTok{gapminder }\OperatorTok{%>%}
\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{dollars_per_day =}\NormalTok{ gdp}\OperatorTok{/}\NormalTok{population}\OperatorTok{/}\DecValTok{365}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(continent }\OperatorTok{==}\StringTok{ "Africa"} \OperatorTok{&}\StringTok{ }\NormalTok{year}\OperatorTok{%in%}\KeywordTok{c}\NormalTok{(}\DecValTok{1970}\NormalTok{,}\DecValTok{2010}\NormalTok{) }\OperatorTok{&}\StringTok{ }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(gdp))}
\NormalTok{daydollars}
\end{Highlighting}
\end{Shaded}
